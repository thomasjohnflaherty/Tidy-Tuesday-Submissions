...
p_load(tidyverse, knitr, data.table, zoo, ggridges)

p_load_gh("hrbrmstr/hrbrthemes")
```

```{r}
path <- "https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2018-05-29/week9_comic_characters.csv"
